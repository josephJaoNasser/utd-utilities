<template>
  <div>
    <b-card class="overflow-hidden" style="max-width: 960px; margin: 0 auto">
      <b-row no-gutters>
        <b-col md="6">
          <UTDButton variant="primay">Upload Photo</UTDButton>
          <UTDButton variant="primay">Create Album</UTDButton>
